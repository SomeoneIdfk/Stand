--[[
    ...
    Credits:
    The Stand Devs
    - Well duh, they created the mod menu.

    hexarobi#3822
    - Created the auto updater. https://github.com/hexarobi/stand-lua-auto-updater
...
auto_updater.run_auto_update({source_url= "https://raw.githubusercontent.com/SomeoneIdfk/Stand/main/safe-menu.lua", script_relpath= "lib/safe-menu.lua", verify_file_begins_with= "--"})
